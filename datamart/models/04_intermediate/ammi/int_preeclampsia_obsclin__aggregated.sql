...
from 
    ...
    inner join {{ ref('int_preeclampsia_study_dates') }} int_preeclampsia_study_dates on int_preeclampsia_study_dates.mother_id = obs_clin.patid
        and obs_clin.obsclin_start_date between int_preeclampsia_study_dates.estimated_pregnancy_start_date and int_preeclampsia_study_dates.feature_window_end_date
where 
    1 = 1
